...
class ExtractTweets:
    ...
    def get_tweet_df(self, save=False)->pd.DataFrame:
        ...
        if save:
            df.to_csv('C:/Users/Admin/Desktop/Desmondonam/Data_Science/twitter_analysis/Data/processed_tweet_data.csv', index=False)
...
if __name__ == "__main__":
    ...
    extracted_tweets = ExtractTweets("C:/Users/Admin/Desktop/Desmondonam/Data_Science/twitter_analysis/Data/Economic_Twitter_Data_minified.json")
